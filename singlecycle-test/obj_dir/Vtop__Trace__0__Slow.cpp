...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+79,"ld_data",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+80,"wb_data",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+28,"funct3",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 2,0);
    tracep->declBus(c+29,"funct7",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 4,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+77,"clk_i",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+78,"rst_ni",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+6,"addr_i",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+7,"rdata_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+79,"ld_data_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+66,"io_lcd_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+67,"io_ledg_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+68,"io_ledr_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+69,"io_hex0_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    tracep->declBus(c+32,"mask",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 3,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+80,"rd_data_i",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+33+i*1,"memory",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+28,((7U & (vlSelf->top__DOT__singleCycle__DOT__instr 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+29,((0x1fU & (vlSelf->top__DOT__singleCycle__DOT__instr 
                                       >> 2U))),5);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__singleCycle__DOT__lsu1__DOT__dataout_1),32);
    bufp->fullIData(oldp+31,(vlSelf->top__DOT__singleCycle__DOT__lsu1__DOT__dataout_2),32);
    bufp->fullCData(oldp+32,(vlSelf->top__DOT__singleCycle__DOT__lsu1__DOT__mask),4);
    bufp->fullIData(oldp+33,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[0]),32);
    bufp->fullIData(oldp+34,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[1]),32);
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[2]),32);
    bufp->fullIData(oldp+36,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[3]),32);
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[4]),32);
    bufp->fullIData(oldp+38,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[5]),32);
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[6]),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[7]),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[8]),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[9]),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[10]),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[11]),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[12]),32);
    bufp->fullIData(oldp+46,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[13]),32);
    bufp->fullIData(oldp+47,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[14]),32);
    bufp->fullIData(oldp+48,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[15]),32);
    bufp->fullIData(oldp+49,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[16]),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[17]),32);
    bufp->fullIData(oldp+51,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[18]),32);
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[19]),32);
    bufp->fullIData(oldp+53,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[20]),32);
    bufp->fullIData(oldp+54,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[21]),32);
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[22]),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[23]),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[24]),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[25]),32);
    bufp->fullIData(oldp+59,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[26]),32);
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[27]),32);
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[28]),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[29]),32);
    bufp->fullIData(oldp+63,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[30]),32);
    bufp->fullIData(oldp+64,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__memory[31]),32);
    ...
    bufp->fullIData(oldp+79,(((1U & ((~ ((IData)(vlSelf->top__DOT__singleCycle__DOT__mem_op) 
                                         >> 2U)) & 
    ...
    bufp->fullIData(oldp+80,(((2U & (IData)(vlSelf->top__DOT__singleCycle__DOT__wb_sel))
